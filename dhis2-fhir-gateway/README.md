...
![FHIR gateway](./docs/images/fhir-gateway.png)
...
![SUSHI init](./docs/images/sushi-init.png)
...
![IG from VS Code](./docs/images/ig-vscode.png)
...
![App from VS Code](./docs/images/app-vscode.png)
...
This concludes our journey in building a simple FHIR gateway for DHIS2. The IG together with the gateway code are available within the directory accompanying this README.